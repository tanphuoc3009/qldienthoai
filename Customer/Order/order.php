...
$thanhToan = isset($_GET['ThanhToan']) ? $_GET['ThanhToan'] : '';
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-3">
                                        <input type="radio" name="TinhTrang" value="2" 
                                               <?php echo $viewData['TinhTrang'] === '2' ? 'checked' : ''; ?>> Đã thành công
                                    </div>
                                    <div class="col-3">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-bordered text-center align-middle">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $i; ?></td>
                                <td><strong><?php echo $donHang['MaDDH']; ?></strong></td>
                                ...
                                <td>
                                    <a href="order_details.php?id=<?php echo $donHang['MaDDH']; ?>"
                                       class="btn" style="background: #fd710d; color: white; margin-right: 5px;">
                                        Chi tiết
                                    </a>
                                        <button type="button" class="btn btn-danger cancel-order-btn" 
                                                data-maddh="<?php echo htmlspecialchars($donHang['MaDDH']); ?>" 
                                                style="border-radius: 5px; color: white;"
                                                <?php echo $donHang['TinhTrang'] == 0 ? '' : 'disabled'; ?>>
                                            Hủy đơn
                                        </button>
                                </td>
                            </tr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p class="text-center" style="color: red; font-weight: bold;">
                        Bạn có chắc chắn muốn hủy đơn hàng <strong id="modalMaDDH"></strong> không?
                    </p>
